...
public class VerReclamos extends AppCompatActivity {
    ...
    private Spinner dropdownFiltro;
    private Spinner dropdownDatoSector;
    private Spinner dropdownDatoPertenencia;
    ...
    private AutenticacionFiltro autenticacionFiltro;
    private String dato;
